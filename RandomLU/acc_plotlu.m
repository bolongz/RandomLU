...
h8 = semilogy(X, rlu_no_err/20, 'c+','LineWidth', 1.5, 'MarkerSize', 8);
h9 = semilogy(X, rlu_no_err1/20, 'gs' ,'LineWidth', 1.5, 'MarkerSize', 8);
h10 = semilogy(X, rlu_no_err2/20, 'mh' ,'LineWidth', 1.5, 'MarkerSize', 8);


h11 = semilogy(X, rlu_b_err/20, 'k*','LineWidth', 1.5, 'MarkerSize', 8);
h12 = semilogy(X, rlu_b_err1/20, 'rd' ,'LineWidth', 1.5, 'MarkerSize', 8);
h13 = semilogy(X, rlu_b_err2/20, 'g^' ,'LineWidth', 1.5, 'MarkerSize', 8);
