...
[A,~] = genTestMatrix(500, 500, 2); %slow decay 
...
h6 = semilogy(X, rlu_err1/20, 'rd' ,'LineWidth', 1.5, 'MarkerSize', 8);
h7 = semilogy(X, rlu_err2/20, 'g^' ,'LineWidth', 1.5, 'MarkerSize', 8);

h8 = semilogy(X, powerlu_err2/20, 'c+', 'LineWidth', 1.5, 'MarkerSize', 8);
h9 = semilogy(X, powerlu_err4/20, 'gs', 'LineWidth', 1.5, 'MarkerSize', 8);
h10 = semilogy(X, powerlu_err6/20, 'mh','LineWidth', 1.5, 'MarkerSize', 8);


h11 = semilogy(X, powerlu_b_err2/20, 'g<', 'LineWidth', 1.5, 'MarkerSize', 8);
h12 = semilogy(X, powerlu_b_err4/20, 'k>', 'LineWidth', 1.5, 'MarkerSize', 8);
h13 = semilogy(X, powerlu_b_err6/20, 'b^','LineWidth', 1.5, 'MarkerSize', 8);
...
'RandLU, p = 1',  'RandLU, p = 2', 'PowerLU, v = 2',  'PowerLU, v = 4', ...
