...
h11 = semilogy(X, powerlu_eb_err2/20, 'r+', 'LineWidth', 1.5, 'MarkerSize', 8);
h12 = semilogy(X, powerlu_eb_err4/20, 'ks', 'LineWidth', 1.5, 'MarkerSize', 8);
h13 = semilogy(X, powerlu_eb_err6/20, 'bp','LineWidth', 1.5, 'MarkerSize', 8);
hold off
